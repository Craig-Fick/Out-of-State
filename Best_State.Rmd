...
*Note: You may need to create an account with Tableau Public to use. If the map goes completely black during use, this means there are no states fitting the range selected. You will need to readjust the ranges for the map to reappear.*
...
__Select one variable at a time in the map below for each variables overall intensity.__
...
*Note: For the politics variable, 0 = Republican and 1 = Democrat.*
